...
// MongoDB URI
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/arjun-foodlink';

console.log('Connecting to:', MONGODB_URI.includes('mongodb+srv') ? 'MongoDB Atlas (Cloud)' : 'MongoDB Local');
...
const UserSchema = new mongoose.Schema({
  ...
  image: String,
  phone: String,
  role: { type: String, enum: ['STUDENT', 'MESS_OWNER', 'ADMIN'], default: 'STUDENT' },
...
const MessSchema = new mongoose.Schema({
  ...
  priceRange: { type: String, enum: ['BUDGET', 'MODERATE', 'PREMIUM'], default: 'MODERATE' },
  monthlyPrice: Number,
  perMealPrice: Number,
